...
class Dashboard_Secretarias extends React.Component {
  ...
  render() {
    ...
    const filteredPacientes = this.filterPacientes(pacientes);
      ...
      <React.Fragment>
        ...
        <div className="container-fluid mt-4" style={{ fontSize: "8pt" }}>
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-2">
              <label htmlFor="searchNumeroExamen">
                  ...
                  {filteredPacientes
                    ...
                    .map((value, index) => {
                      ...
                      return (
                        ...
                        <td>{paciente ? paciente.fecha_entrega_de_ampliacion_area_de_ihq : '-'}</td> {/* Mostrar desde pacientes */}
                        <td>
                          <button
